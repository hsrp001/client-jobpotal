...
function Notifation() {
  return (
    ...
    <div class="  " id="chec-div">
        <div class="w-full   pt-16" id="notification">
            <div class=" w-full bg-gray-50 min-h-screen  p-8 ">
                ...
                <div class="w-full p-3 mt-8 bg-white rounded flex">
                    ...
                    <div class="pl-3">
                        <p tabindex="0" class=" abfocus:outline-none text-sm leading-none"><span class="text-indigo-700">James Doe</span> favourited an <span class="text-indigo-700">item</span></p>

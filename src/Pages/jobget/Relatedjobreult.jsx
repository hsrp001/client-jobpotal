...
const {id} = useParams()
  ...
  useEffect(() => {
    function handleScroll() {
      ...
      // If scrolled to the bottom, set the jobTextHeight to 50vh, else keep it 70vh
      setJobTextHeight(isBottom ? '55vh' : '63vh');
    }
  ...
  return (
    <div className={`${isFixed ? 'fixed px-5' : ''} bg-slate-800 top-20 z-50 mb-56 bottom-0 `}>
     {

...
const Navbar = () => {
 ...
 const{data, userdata , logout ,post}= useContext(MyContext)
 const id=1
...
const handleLogout = () => {
 ...
 if( see)
 {
  ...
  return (
    <>
      <nav class=" bg-white shadow-md fixed left-0 right-0 z-50  ">
...
data || post ? 
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 ">
        ...
        <span className=" absolute bg-blue-900 w-5 h-5  text-sm  left-0 m-5 text-white  rounded-3xl -mt-2 ">1</span>
...
null
  ...
  <div class={`sm:hidden ${!show ?"hidden":"block"}`}    id="mobile-menu">
